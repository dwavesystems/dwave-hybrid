...
import dimod
from dwave.graphs import canonical_chimera_labeling
...
def chimera_tiles(bqm, m, n, t):
    ...
    Returns:
        ...
        Embeddings are those that would be generated by `dwave-graph`'s
    ...
    Examples:
        ...
        >>> import dwave.graphs
        >>> import dimod
        >>> G = dwave.graphs.chimera_graph(1, 2)     # Create a Chimera-based BQM
